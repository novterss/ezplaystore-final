            ...
            <div className="container mx-auto px-4 pt-28 pb-16">
                ...
                >
                    ...
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h1 className="text-3xl md:text-4xl font-bold">{t.termsPage.title}</h1>
                    </div>

                    {/* Content */}
                    <div className="space-y-6 bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                        {t.termsPage.sections.map((section: { title: string; content: string }, index: number) => (
                        ...
                        <div className="pt-6 border-t border-white/10 text-sm text-gray-500">
                            <p>{t.termsPage.lastUpdated}: {t.termsPage.date}</p>
                        </div>
                    </div>
                </motion.div>
            </div>
